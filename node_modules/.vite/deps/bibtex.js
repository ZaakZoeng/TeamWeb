  ...
  "node_modules/bibtex/index.js"(exports, module) {
    !function(e, t) {
      ...
      return function(e) {
        ...
        "use strict";
        function r(e2, t2) {
          if ("string" != typeof e2) throw new Error("Expected to be string: " + JSON.stringify(t2 || e2));
          return e2;
        }
        function s(e2, t2) {
          if (void 0 === e2) throw new Error("Expected to be defined: " + JSON.stringify(t2 || e2));
          return e2;
        }
        function o(e2, t2) {
          if (!i(e2)) throw new Error("Expected to be array: " + JSON.stringify(t2 || e2));
          return e2;
        }
        function i(e2) {
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.mustBeString = r, t.mustBeDefined = s, t.mustBeArray = o, t.isArray = i, t.isNumber = a, t.isString = u, t.flattenMyArray = function(e2, n2) {
          ...
          for (var r2 = 0, s2 = e2.length; r2 < s2; r2++) {
            var o2 = e2[r2];
            if (Array.isArray(o2)) for (var i2 = 0, a2 = o2.length; i2 < a2; i2++) {
              var u2 = o2[i2];
        ...
        var o = this && this.__extends || function() {
          var e2 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e3, t2) {
            ...
            for (var n2 in t2) t2.hasOwnProperty(n2) && (e3[n2] = t2[n2]);
          };
        ...
        function i(e2, t2) {
          if (d.isNumber(t2) || d.isString(t2)) return t2;
          if (y.isStringRef(t2)) return new y.StringRef(0, t2.stringref);
          switch (d.mustBeString(t2.type, t2)) {
            ...
            case "bracedstring":
            case "braced":
              if (!d.isArray(t2.data)) throw new Error("Expect array for data: " + JSON.stringify(t2));
        ...
        function a(e2) {
          if (d.isString(e2)) return e2;
          if (d.isNumber(e2)) return e2 + "";
          if (h.isBracedString(e2) || $.isQuotedString(e2) || $.isOuterQuotedString(e2) || h.isOuterBracedString(e2)) return u(e2.data);
        ...
        function p(e2, t2) {
          if (h.isBracedString(e2)) return e2;
          if ($.isQuotedString(e2)) {
            var n2 = c(e2.data, true);
            return d.isArray(n2) ? t2 ? n2 : _.concat(n2).concat(_) : t2 ? n2 : ['"', n2, '"'];
          }
          if ($.isOuterQuotedString(e2)) return c(e2.data, true);
          if (h.isOuterBracedString(e2)) return c(e2.data, false);
          if (d.isString(e2) || d.isNumber(e2)) return e2;
        ...
        function b(e2) {
          for (var t2 = [], n2 = 0, r2 = e2; n2 < r2.length; n2++) {
            var o2 = r2[n2];
            if (d.isString(o2) || d.isNumber(o2)) if (t2.length <= 0) {
              var i2 = { type: "ContiguousSimpleString", data: [o2] };
              t2.push(i2);
            } else {
              var a2 = t2[t2.length - 1];
              if (s(a2)) a2.data.push(o2);
              else {
                var i2 = { type: "ContiguousSimpleString", data: [o2] };
                t2.push(i2);
              }
        ...
        var s = n(0), o = function() {
          ...
          return e2.isBibStringComponent = function(e3) {
            ...
            if (s.isString(t2)) return t2;
            if (s.isNumber(t2)) return t2.toString();
            if (e2.isBibStringComponent(t2)) return t2.stringify();
        ...
        function s(e2) {
          if (r(e2)) return { key: e2.key, value: o(e2.value) };
          throw new Error("Was not a KeyVal: " + JSON.stringify(e2));
        }
        function o(e2) {
          if (c.isNumber(e2)) return e2;
        ...
        function i(e2) {
          if (e2) return c.isNumber(e2) ? e2 : e2.stringify();
        }
        Object.defineProperty(t, "__esModule", { value: true });
        ...
        function s(e2) {
          if (b.isKeyVal(e2)) return b.newKeyVal(e2);
          if ("string" !== e2.type) throw new Error("Unexpected node: " + JSON.stringify(e2));
          return s(e2.data);
        }
        function o(e2) {
          var t2 = {};
        ...
        function i(e2, t2, n2, r2) {
          return e2.data.map(function(e3) {
            if (y.isString(e3) || y.isNumber(e3)) return e3;
            if (l.isStringRef(e3)) return u(t2, r2, e3, n2);
            if (h.isBibStringComponent(e3)) return c(e3, t2, n2, r2);
            throw new Error();
          });
        }
        ...
        function u(e2, t2, n2, r2) {
          var s2 = n2.stringref;
          if (e2[s2]) throw new Error("Cycle detected: " + s2);
          if (r2[s2]) return r2[s2];
          if (!t2[s2]) throw new Error('Unresolved reference: "' + n2.stringref + '" (' + JSON.stringify(n2) + ")");
        ...
        function c(e2, t2, n2, r2) {
          ...
          if (f.isQuotedString(e2)) return new f.QuotedString(o2, s2);
          if (m.isBracedString(e2)) return new m.BracedString(o2, s2);
          if (f.isOuterQuotedString(e2)) return new f.OuterQuotedString(s2);
          if (m.isOuterBracedString(e2)) return new m.OuterBracedString(s2);
          throw new Error();
        }
        function p(e2, t2, n2, r2) {
          var s2 = c(e2, t2, n2, r2);
          if (!m.isOuterBracedString(s2) && !f.isOuterQuotedString(s2)) throw new Error();
          return s2;
        }
        Object.defineProperty(t, "__esModule", { value: true });
        var b = n(6), l = n(5), f = n(1), m = n(2), y = n(0), h = n(3), $ = /* @__PURE__ */ function() {
          function e2(e3, t2) {
        ...
        function o(e2) {
          ...
          if (m.isQuotedString(e2)) return !(!e2.data || e2.data.length <= 0) && o(e2.data[0]);
          if (y.isStringRef(e2) || m.isOuterQuotedString(e2) || h.isOuterBracedString(e2)) throw new Error("Should not do this test on this type");
          return false;
        }
        function i(e2) {
          for (var t2 = $.splitOnPattern(e2, d), n2 = -1, r2 = -1, o2 = -1, i2 = 0; i2 < t2.length - 1; i2++) s(t2[i2]) && (n2 < 0 && (n2 = i2), r2 = i2 + 1);
          o2 = n2 >= 0 ? n2 : t2.length - 1;
          var a2 = n2 >= 0 ? u(t2, n2, r2) : [], c2 = u(t2, 0, o2), p2 = u(t2, Math.max(r2, o2), t2.length);
          return new _(c2, a2, p2, []);
        }
        function a(e2, t2) {
          for (var n2 = $.splitOnPattern(e2, d), r2 = $.splitOnPattern(t2, d), o2 = -1, i2 = -1, a2 = 0; a2 < n2.length - 1; a2++) s(n2[a2]) && (o2 < 0 && (o2 = a2), i2 = a2 + 1);
          var c2 = o2 >= 0 ? u(n2, 0, i2) : [], p2 = r2, b2 = u(n2, Math.max(i2, 0));
          return new _(p2, c2, b2, []);
        }
        function u(e2, t2, n2) {
          for (var r2 = [], s2 = t2; s2 < (void 0 === n2 ? e2.length : n2); s2++) r2.push(e2[s2]);
          return r2;
        }
        function c(e2, t2, n2) {
          for (var r2 = $.splitOnPattern(e2, d), o2 = $.splitOnPattern(n2, d), i2 = $.splitOnPattern(t2, d), a2 = -1, c2 = -1, p2 = 0; p2 < r2.length - 1; p2++) s(r2[p2]) && (a2 < 0 && (a2 = p2), c2 = p2 + 1);
        ...
        Object.defineProperty(t, "__esModule", { value: true });
        var f = n(0), m = n(1), y = n(5), h = n(2), $ = n(3), d = /\s+/g, _ = /* @__PURE__ */ function() {
        ...
        "use strict";
        function r(e2) {
          if (!u.isArray(e2.data) || "NON_ENTRY" !== e2.type) throw new Error();
        ...
        function s(e2) {
          switch (typeof e2) {
            case "object":
              var t2 = e2.data;
              if ("string" == typeof t2["@type"]) return new p.BibEntry(t2["@type"], t2._id, p.parseEntryFields(t2.fields));
        ...
        "use strict";
        function r(e2) {
          for (var n2 in e2) t.hasOwnProperty(n2) || (t[n2] = e2[n2]);
        }
        ...
        t.address = "address", t.author = "author", t.booktitle = "booktitle", t.chapter = "chapter", t.edition = "edition", t.editor = "editor", t.howpublished = "howpublished", t.institution = "institution", t.journal = "journal", t.month = "month", t.note = "note", t.number = "number", t.organization = "organization", t.pages = "pages", t.publisher = "publisher", t.school = "school", t.series = "series", t.title = "title", t.type = "type", t.volume = "volume", t.year = "year", t.optionalFields = { book: [["volume", "number"], "series", "address", "edition", "month", "note"], booklet: ["author", "howpublished", "address", "address", "month", "year", "note"], conference: ["editor", ["volume", "number"], "series", "pages", "address", "month", "organization", "publisher", "note"], inproceedings: ["editor", ["volume", "number"], t.series, "pages", "address", "month", "organization", "publisher", "note"], inbook: ["volume", "number", "series", "type", "address", "edition", "month", "note"], incollection: ["editor", ["volume", "number"], "series", "type", "chapter", "pages", "address", "edition", "month", "note"], manual: ["author", "organization", "year", "address", "edition", "month", "note"], mastersthesis: ["type", "address", "month", "note"], misc: [], phdthesis: ["type", "address", "month", "note"], proceedings: ["editor", ["volume", "number"], "series", "address", "month", "organization", "publisher", "note"], techreport: ["type", "address", "number", "month", "note"], unpublished: ["month", "year"] }, t.mandatoryFields = { article: ["author", "title", "year", "journal"], book: [["author", "editor"], "title", "publisher", "year"], booklet: ["title"], conference: ["author", "title", "booktitle", "year"], inproceedings: ["author", "title", "booktitle", "year"], inbook: [["author", "editor"], "title", ["chapter", "pages"]], incollection: ["author", "title", "booktitle", "publisher", "year"], manual: ["title"], mastersthesis: ["author", "title", "school", "year"], misc: [["author", "title", "howpublished", "year", "month", "note"]], phdthesis: ["author", "title", "school", "year"], proceedings: ["year", "title"], techreport: ["author", "title", "institution", "year"], unpublished: ["author", "title", "note"] }, t.hasOptionalFields = r, t.hasMandatoryFields = s, t.getMandatoryFields = o, t.getOptionalFields = i, t.findError = function(e2, t2) {
          var n2 = e2.fields;
          if (a.isString(t2)) {
            if (!n2[t2]) return new Error("Warning: expected " + e2.type + " with id " + e2._id + " to have the field: " + t2);
          } else if (a.isArray(t2)) {
            var r2 = t2.reduce(function(e3, t3) {
              if (a.isString(t3)) return e3 && n2.hasOwnProperty(t3);
              throw new Error();
            }, true);
            if (!r2) return new Error("Expected " + e2.type + " with id " + e2._id + " to have one of the following fields: " + t2);
          }
        };
      }, function(e, t) {
        !function(t2, n) {
          ...
          function o(e3, t3, o2) {
            if (e3 instanceof r) var i = e3, o2 = t3;
            else var i = r.fromCompiled(e3, t3);
            this.grammar = i, this.options = { keepHistory: false, lexer: i.lexer || new s() };
            for (var a in o2 || {}) this.options[a] = o2[a];
          ...
          return e2.highestId = 0, e2.prototype.toString = function(e3) {
            ...
            for (var t3 = this.states, n2 = this.wants, r2 = this.completed, s2 = 0; s2 < t3.length; s2++) {
              ...
              if (i.isComplete) {
                ...
                if (n2[p]) {
                  if (n2[p].push(i), r2.hasOwnProperty(p)) for (var b = r2[p], u = 0; u < b.length; u++) {
                    var l = b[u];
                    this.complete(i, l);
                  }
                } else n2[p] = [i], this.predict(p);
              }
            }
        ...
        function s(e2, t2) {
          if ("keyval" !== t2.type) throw new Error("Expected a keyval object");
          var n2 = t2.key.toLowerCase();
          return e2.fields[n2] ? void 0 : (e2.fields[n2] = t2.value, e2);
        }
        function o(e2) {
          for (var t2 = [], n2 = 0; n2 < e2.length; n2++) if ("object" == typeof e2[n2]) {
            if (!e2[n2].string) throw new Error("Expected token to have a string field called 'string' in object " + JSON.stringify(e2[n2]));
            t2.push(e2[n2].string);
          } else {
            if ("string" != typeof e2[n2] && "number" != typeof e2[n2]) throw new Error("Could not handle token " + JSON.stringify(e2[n2]) + " in array " + JSON.stringify(e2));
            t2.push(e2[n2]);
          }
          return t2.join("");
        }
        ...
        t.grammar = { Lexer: void 0, ParserRules: [{ name: "main$ebnf$1", symbols: ["non_entry"], postprocess: r }, { name: "main$ebnf$1", symbols: [], postprocess: function() {
          ...
          for (var n2 = 0; n2 < e2[1].length; n2++) t2.push({ type: "ENTRY", data: e2[1][n2][0] }), e2[1][n2][1] && t2.push({ type: "NON_ENTRY", data: e2[1][n2][1] });
          return t2;
          ...
          for (var t2 = [], n2 = 0; n2 < e2[0].length; n2++) t2.push(e2[0][n2][0]);
          return t2;
          ...
          for (var t2 = { _id: e2[0], fields: [] }, n2 = e2[4], r2 = 0; r2 < n2.length; r2++) t2.fields.push(n2[r2][0]);
          ...
          for (var n2 = e2[2].fields, r2 = 0; r2 < n2.length; r2++) s(t2, n2[r2]);
          return t2;
          ...
          var t2 = [];
          for (var n2 in e2[1]) t2.push(e2[1][n2][0]);
          ...
          if (2 === t2.length) {
            var n2 = [];
            n2.push(t2[0]);
            for (var r2 = 0; r2 < t2[1].length; r2++) n2.push(t2[1][r2][3]);
            return { type: "quotedstringwrapper", data: n2 };
          }
          if ("braced" === t2[0].type) return { type: "bracedstringwrapper", data: t2[0].data };
          ...
          if ("object" == typeof e2[0][0]) {
            if (!e2[0][0].string) throw new Error("Expected " + e2[0] + "to have a 'string' field");
            return e2[0][0].string;
          }
          if ("string" != typeof e2[0][0] && "number" != typeof e2[0][0]) throw new Error("Expected " + e2[0][0] + " to be a string");
          return e2[0][0];
        ...
        var r = n(14), s = n(15), o = n(16), i = n(22), a = n(23), u = function() {
          ...
          return e2.prototype.getStringUntilNonEscapedChar = function(e3) {
            for (var t2 = [], n2 = this.pos; n2 < this.len + 1; n2++) {
              if (this.pos = n2, "\\" == this.str.charAt(n2) && this.str.charAt(n2 + 1).match(e3)) n2++, this.pos = n2;
              else if (this.str.charAt(n2).match(e3)) break;
              t2.push(this.str.charAt(n2));
            }
            return t2.join("");
          }, e2.prototype.readTokens = function() {
            for (var e3, t2 = []; e3 = this.readNextToken(); ) t2.push(e3);
            return t2;
            ...
            var i2 = t2.join("");
            if ("0" === t2[0]) return o.newNumber(i2);
            ...
            for (var e3 = []; this.pos < this.len + 1; ) {
              ...
              if (!s.isSingleWhiteSpaceCharacter(t2)) break;
              e3.push(t2), this.pos++;
            }
